...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><i class="fa fa-bars"></i><span>Tag</span></li>
    </ol>
</section>
        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="pull-right">
                        <div class="btn-group pull-right" style="margin-right: 10px">                           
                            {!! Form::open(array('route' => 'tag.index','method'=>'GET','id'=>'srchfrm')) !!}
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>                                
                                ...
                                <td>
                                    <a href="{{ route('tag.edit',$data->id) }}"> <i class="fa fa-edit"></i></a>  
                                   
                                    <form id="delete-form-{{ $data->id }}" method="post" action="{{ route('tag.destroy',$data->id) }}" style="display: none">
                                        {{ csrf_field() }}
                                        {{ method_field('DELETE') }}
                                </form>
                ...
                <div class="box-footer clearfix">                   
                    ...
                    @if(!$tagdata->isEmpty())
                    Showing <b>{{ $tagdata->firstItem() }}</b> to <b>{{ $tagdata->lastItem() }}</b> of <b>{{ $tagdata->total() }}</b> entries
                    {{ $tagdata->links() }}
                    @endif
                </div>
                <!-- /.box-body -->
