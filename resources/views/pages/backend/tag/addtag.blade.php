...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><i class="fa fa-bars"></i><span>Create Tag</span></li>
    </ol>
</section>
        ...
        <div class="col-md-12">
            <div class="box box-info">
                ...
                @include('includes.admin.flash-message')
                 <!-- form start -->
                <form action="{{ route('tag.store') }}" method="post" accept-charset="UTF-8" class="form-horizontal" pjax-container>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control name" name="name" id="name" placeholder="Tag Name" value="{{ old('name') }}" required />
                                    </div>
                                </div>
                                </div>
