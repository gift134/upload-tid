        ...
        <div class="col-md-12">
            <div class="box box-info">
                ...
                @include('includes.admin.flash-message')
                 <!-- form start -->
                <form action="{{ route('post.store') }}" method="post" accept-charset="UTF-8" enctype="multipart/form-data" class="form-horizontal" pjax-container>
                    ...
                    <div class="box-body">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control name" name="title" id="title" placeholder="Post Title" value="{{ old('title') }}" required />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-pencil"></i></span>
                                        <input type="text" class="form-control name" name="subtitle" id="subtitle" placeholder="Post Sub Title" value="{{ old('subtitle') }}" required />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-pencil"></i></span>
                                        <input type="text" class="form-control name" name="keyword" id="keyword" placeholder="Post Meta Keyword" value="{{ old('keyword') }}" required />
                        ...
                        <div class="col-lg-6">
                         ...
                         <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="">
                                        <textarea class="textarea ckeditor" placeholder="Content " style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" id="body" name="body" >{!! old('body') !!}</textarea>
                                    </div>
