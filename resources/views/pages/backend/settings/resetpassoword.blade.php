...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><i class="fa fa-bars"></i><span>Change Password</span></li>
    </ol>
</section>
        ...
        <div class="col-md-12">
            <div class="box box-info">
                ...
                @include('includes.admin.flash-message')
                 <!-- form start -->
                <form action="{{ route('changepassword') }}" method="post" accept-charset="UTF-8" class="form-horizontal" pjax-container>
                        ...
                        <div class="fields-group">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <input type="password" class="form-control password" name="current_password" id="curpassword" placeholder="Current Password" value="{{ old('current_password') }}" required />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-eye-slash"></i></span>
                                        <input type="password" class="form-control password" name="password" id="newpassword" placeholder="New Password" value="{{ old('password') }}" required />
