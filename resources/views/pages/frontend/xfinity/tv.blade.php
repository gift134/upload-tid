...
<section id="xfinity_intro_tv" class="d-flex align-items-center">
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-7 pt-5 pt-lg-0 order-2 order-lg-1">
        ...
        <a href="tel:{{ Helper::providers_phone_type(8,'phone_tv') }}" class="btn-get-started scrollto">Call {{ Helper::providers_phone_type(8,'phone_tv') }}</a>
      </div>
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="fade-up">
            <div class="price-box">
              ...
              <div class="btn-wrap">
                <a href="tel:{{ Helper::providers_phone_type(8,'phone_tv') }}" class="btn-call">Call {{ Helper::providers_phone_type(8,'phone_tv') }}</a>
              </div>
            </div>
          </div>
        ...
        <div class="container">
          <div class="row justify-content-between justify-content-center align-items-center">
            ...
            <div class="col-lg-5 order-1 order-lg-2 spectrum_intro-img" data-aos="fade-up" data-aos-delay="100">
                <img src="/resources/assets/front_assets/img/xfinity/entertainment2.jpg" class="img-fluid animated" alt="Xfinity Streampix">
            </div>
        ...
        <div class="container">
          <div class="row justify-content-between justify-content-center align-items-center">
            ...
            <div class="col-lg-5 order-1 order-lg-1 spectrum_intro-img" data-aos="fade-up" data-aos-delay="200">
                <img src="/resources/assets/front_assets/img/spectrum/entertainment.jpg" class="img-fluid animated" alt="Xfinity TV and network">
            </div>
      ...
      <section>
        <div class="container">
          <div class="row justify-content-between justify-content-center align-items-center">
            ...
            <div class="col-lg-5 order-1 order-lg-2 spectrum_intro-img" data-aos="fade-up" data-aos-delay="100">
                <img src="/resources/assets/front_assets/img/xfinity/tv-live.jpg" class="img-fluid animated" alt="Xfinity from Comcast Cable TV">
            </div>
