    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
          <div class="icon-box">
            <div class="icon"><img src="/resources/assets/images/number-one.png" alt="Step 1 TV Internet Deals" loading="lazy"></div>
        ...
        <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
          <div class="icon-box">
            <div class="icon"><img src="/resources/assets/images/number-two.png" alt="Step 2 TV Internet Deals" loading="lazy"></div>
        ...
        <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
          <div class="icon-box">
            <div class="icon"><img src="/resources/assets/images/number-three.png" alt="Step 3 TV Internet Deals" loading="lazy"></div>
        ...
        <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
          <div class="icon-box">
            <div class="icon"><img src="/resources/assets/images/number-four.png" alt="Step 4 TV Internet Deals" loading="lazy"></div>
            ...
            <section class="section-content" style="padding-bottom: 0px;">
                ...
                <div class="container">
                  ...
                  <div class="row justify-content-between justify-content-center align-items-center">
                    ...
                    <div class="col-lg-6 order-1 order-lg-1 spectrum_intro-img aos-init aos-animate" style="margin-top: auto;" data-aos="fade-up" data-aos-delay="200">
                        <img src="/resources/assets/images/best-tips-4.jpg" class="img-fluid animated" alt="How to Find The Best Internet Provider in My Area? | TV Internet Deals" loading="lazy">
                    </div>
        
                    <div class="col-lg-6 pt-5 pt-lg-0 order-1 order-lg-2 aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="container">
                  <div class="row justify-content-between justify-content-center align-items-center">
                    ...
                    <div class="col-lg-6 order-1 order-lg-2 spectrum_intro-img aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                        <img src="/resources/assets/images/watching-tv-4.jpg" class="img-fluid animated" alt="TV Avangers | TV Internet Deals" loading="lazy">
                    </div>
