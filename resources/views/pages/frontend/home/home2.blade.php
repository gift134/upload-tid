    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6">
                <div class="search-steps-card-outer">
                    <div class="card-img">
                        <img class="card-1" src="/resources/assets/images/1.png" alt="Select the Provider that suits you.">
                    </div>
                    <div class="search-steps-card">
                        <h3>Select a <br>Plan and Call Us!</h3>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="search-steps-card-outer">
                    <div class="card-img ">
                        <img class="card-2" src="/resources/assets/images/2.png" alt="Select the Provider that suits you.">
                    </div>
                    <div class="search-steps-card">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="search-steps-card-outer">
                    <div class="card-img">
                        <img class="card-3" src="/resources/assets/images/3.png" alt="Select the Provider that suits you.">
                    </div>
                    <div class="search-steps-card">
                        <h3>Select the Provider <br>that suits you.</h3>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="search-steps-card-outer">
                    <div class="card-img">
                        <img class="card-4" src="/resources/assets/images/4.png" alt="Select the Provider that suits you.">
                    </div>
                    <div class="search-steps-card">
                        <h3>Select a <br>Plan and Call Us!</h3>
                    </div>
      ...
      <section class="section-content">
        ...
        <div class="container">
          ...
          <div class="row justify-content-between justify-content-center align-items-center">
            ...
            <div class="col-lg-5 order-1 order-lg-1 spectrum_intro-img aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
                <img src="/resources/assets/images/us-map-1.png" class="img-fluid animated" alt="How to Find The Best Internet Provider in My Area? | TV Internet Deals" loading="lazy">
            ...
            <div class="col-lg-7 pt-5 pt-lg-0 order-1 order-lg-2 aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
              ...
              <p class="description">Looking for the best internet provider that fits your need is a long process. But upgrading your ISP can make a huge difference. To answer questions like "What is the best internet provider near me?", What is the cheapest internet?" or "What is the best internet plan?" Here are several tips on how to search for the best internet service provider in your area.</p>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="steps-2-card">
                            <img src="/resources/assets/images/1.png" alt="">
        ...
        <div class="container">
          <div class="row justify-content-between justify-content-center align-items-center">
            ...
            <div class="col-lg-5 order-1 order-lg-2 spectrum_intro-img aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                <img src="/resources/assets/images/home-img-2.png" class="img-fluid animated" alt="TV Avangers | TV Internet Deals" loading="lazy">
            </div>
