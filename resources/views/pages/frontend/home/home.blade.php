...
<section class="find-steps">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-3 col-md-6 p-0">
                <div class="step-card">
  ...
  <section class="provider">
      ...
      <section class="section-content" style="border-bottom:1px solid #1fc56f;padding-bottom: 0px;">
        ...
        <div class="container">
          <div class="row justify-content-between justify-content-center align-items-center">
            ...
            <div class="col-lg-5 order-1 order-lg-2 spectrum_intro-img aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                <img src="/resources/assets/images/sec-tv-1.png" class="img-fluid animated" alt="TV Avangers | TV Internet Deals" loading="lazy">
            </div>
