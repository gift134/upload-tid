        ...
        <ul>
            <li class="flag">
              <p class="steps">Step 1</p>
                <p class="steps-info">Enter your location</p>
            </li>
            <li class="flag">
                <p class="steps">Step 2</p>
                <p class="steps-info">Compare each Providers.</p>
            </li>
            <li class="flag">
                <p class="steps">Step 3</p>
                <p class="steps-info">Select the Provider that suits you.</p>
            </li>
            <li class="flag">
                <p class="steps">Step 4</p>
                <p class="steps-info">Select a Plan and Call Us!</p>
            </li>
...
{{-- <section class="find-steps">
        ...
        <div class="row">
            <div class="col-md-3 p-0">
                <div class="step-card">
                    ...
                    <div class="plans-body">
                        <img src="/resources/assets/images/pin.png" alt="Enter your location">
            ...
            <div class="col-md-3 p-0">
                <div class="step-card">
                    ...
                    <div class="arrow-up"></div>
                    <div class="plans-body">
                        <img src="/resources/assets/images/analytics.png" alt="Compare each Providers.">
            ...
            <div class="col-md-3 p-0">
                <div class="step-card">
                    ...
                    <div class="arrow-up"></div>
                    <div class="plans-body">
                        <img src="/resources/assets/images/rating.png" alt="Select the Provider that suits you.">
            ...
            <div class="col-md-3 p-0">
                <div class="step-card">
                    ...
                    <div class="arrow-up"></div>
                    <div class="plans-body">
                        <img src="/resources/assets/images/phone-call.png" alt="Select a Plan and Call Us!">
  ...
  <section class="provider">
      ...
      <section class="section-content" style="border-bottom: 1px solid rgb(0 123 255 / 25%);;padding-bottom: 0px;">
        ...
        <div class="container">
          ...
          <div class="row justify-content-between justify-content-center align-items-center">
            ...
            <div class="col-lg-5 order-1 order-lg-1 spectrum_intro-img aos-init aos-animate" style="margin-top: auto;" data-aos="fade-up" data-aos-delay="200">
                <img src="/resources/assets/images/tablet-phone-search-5.png" class="img-fluid animated" alt="How to Find The Best Internet Provider in My Area? | TV Internet Deals" loading="lazy">
            </div>
        ...
        <div class="container">
          <div class="row justify-content-between justify-content-center align-items-center">
            ...
            <div class="col-lg-5 order-1 order-lg-2 spectrum_intro-img aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                <img src="/resources/assets/images/tv-5.png" class="img-fluid animated" alt="TV Avangers | TV Internet Deals" loading="lazy">
            </div>
