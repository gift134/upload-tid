    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
          <div class="icon-box">
            <div class="icon"><img src="/resources/assets/images/map-marker.png" alt="Step 1 TV Internet Deals" loading="lazy"></div>
            <h4 class="title">STEP 1</h4>
            <p class="description"><span>Enter</span> your location</p>
          </div>
        </div>

        <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
          <div class="icon-box">
            <div class="icon"><img src="/resources/assets/images/computer.png" alt="Step 2 TV Internet Deals" loading="lazy"></div>
            <h4 class="title">STEP 2</h4>
            <p class="description"><span>Compare</span> each Providers.</p>
          </div>
        </div>

        <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
          <div class="icon-box">
            <div class="icon"><img src="/resources/assets/images/select-option.png" alt="Step 3 TV Internet Deals" loading="lazy"></div>
            <h4 class="title">STEP 3</h4>
            <p class="description"><span>Select</span> the Provider that suits you.</p>
          </div>
        </div>

        <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
          <div class="icon-box">
            <div class="icon"><img src="/resources/assets/images/take-phone-call.png" alt="Step 4 TV Internet Deals" loading="lazy"></div>
            <h4 class="title">STEP 4</h4>
            <p class="description"><span>Select</span> a Plan and <span>Call Us!</span> </p>
          </div>
        </div>
      ...
      <section class="section-content">
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-lg-6 order-2 spectrum_intro-img aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
                {{-- <img src="/resources/assets/images/half-iphone.png" class="img-fluid animated" alt="How to Find The Best Internet Provider in My Area? | TV Internet Deals" loading="lazy"> --}}
            
                
                    <div class="row">
                        <div class="col-md-12">
                            <div class="step-tips d-inline-flex">
                                <img src="/resources/assets/images/number-1.png" alt="">
                                <p>Go to our Search page and enter your Zipcode to look for the complete internet provider list with their best package, deals, and plans.</p>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="step-tips d-inline-flex">
                                <img src="/resources/assets/images/number-2.png" alt="">
                                <p>Ask your friends, families, and neighbors and hear their experience and what is their first choice.</p>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="step-tips d-inline-flex">
                                <img src="/resources/assets/images/number-3.png" alt="">
                                <p>Ask for professional advice across trusted websites, forums, social media, and reliable sources. </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-6 pt-5 pt-lg-0 order-1  aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
              ...
              {{-- <img class="img-fluid" src="/resources/assets/images/Select-amico.png" alt=""> --}}
                {{-- <ol>
      ...
      <section class="section-content">
        <div class="container">
          <div class="row justify-content-between justify-content-center align-items-center">
            ...
            <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">

              <h4 class="title">How Many Cable Provider Near Me?</h4>
              <p class="">Entertainment is the soul of any home. TV brings everyone together from around the world. The reason why you need to invest more time looking for the best cable provider in your area.</p>
              <p class="">Here at TV Internet Deals, we answer all your questions like "how many channels can I fit in my plan given the budget?" or "Do I have access to multiple cable companies in my area?" Simply follow the steps mentioned above by Entering your Zipcode on the search bar, and we will the rest for you</p>

              </div>

            <div class="col-lg-6 order-1 order-lg-2 spectrum_intro-img aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                <img src="/resources/assets/images/tv-laptop-3.png" class="img-fluid animated" alt="TV Avangers | TV Internet Deals" loading="lazy">
            </div>
