    ...
    <meta name="author" content="Vivint Home Security Authorized Dealer">
...
{{-- <link href="/resources/assets/vivint_assets/css/style.css" rel="stylesheet"> --}}

<link rel="stylesheet" href="{{ url('public/css/app_vivint.css')}}">
