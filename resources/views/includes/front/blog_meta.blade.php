...
<link rel="canonical" href="{{url()->current()}}"/>
    ...
    <meta property="og:image" content="{{asset('public/uploads/original/'.$blogdata->image) }}">
    ...
    <meta property="twitter:image" content="{{asset('public/uploads/original/'.$blogdata->image) }}">
...
<!--<link async href="{{ url('resources/assets/front_assets/css/home/style.css') }}" rel="stylesheet">-->

<link async rel="shortcut icon" href="{{ asset('https://raw.githubusercontent.com/gift134/jna/master/front_assets/img/favicon.ico.png') }}">

<!--<link async href="https://cdn.jsdelivr.net/npm/boxicons@2.0.5/css/boxicons.css" rel="stylesheet">-->
...
.EveryState ul li a:hover {
    color: #594ff7;
    border-bottom: 1px solid #594ff7;
    padding-bottom: 2px
}
