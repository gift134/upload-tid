...
<link async href="{{ url('resources/assets/front_assets/css/buckeyebroadband/style.css') }}" rel="stylesheet"> --}}

<link rel="stylesheet" href="{{ url('public/css/app_buckeye.css')}}">
