...
<!-- Favicons -->
{{-- <link href="resources/assets/front_assets/img/favicon.png" rel="icon">
<link href="resources/assets/front_assets/img/apple-touch-icon.png" rel="apple-touch-icon"> --}}
...
<link href="{{ url('resources/assets/front_assets/vendor/animate.css/animate.min.css') }}" rel="stylesheet">
<link href="{{ url('resources/assets/front_assets/vendor/remixicon/remixicon.css') }}" rel="stylesheet">
...
<link rel="stylesheet" href="{{ url('public/css/app_tmobile.css')}}">


<!-- Template Main CSS File -->


{{-- <link href="{{ url('resources/assets/front_assets/css/tmobile/style.css') }}" rel="stylesheet"> --}}
